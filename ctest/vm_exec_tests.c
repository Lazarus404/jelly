...
static void assert_bool_eq(const char* test, jelly_value v, int want, const char* msg) {
  if(!jelly_is_bool(v) || (int)jelly_as_bool(v) != want) {
    failf(test, msg);
  }
}
...
static int run_exec_i32_imm_arith(void) {
  const char* t = "exec_i32_imm_arith";
  uint8_t buf[512];
  size_t off = 0;
  ...
  /* r0=10; r1=r0+5; r2=r1-3; r3=r2*2; ret r3 -> 24 */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 10);
  wr_insn(buf, &off, (uint8_t)JOP_ADD_I32_IMM, 1, 0, 5, 0);   /* r1 = r0 + 5 = 15 */
  wr_insn(buf, &off, (uint8_t)JOP_SUB_I32_IMM, 2, 1, 3, 0);   /* r2 = r1 - 3 = 12 */
  wr_insn(buf, &off, (uint8_t)JOP_MUL_I32_IMM, 3, 2, 2, 0);   /* r3 = r2 * 2 = 24 */
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 24, "result is 24");
...
static int run_exec_i32_imm_cmp(void) {
  const char* t = "exec_i32_imm_cmp";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 2); off += 4;  /* ntypes: I32, Bool */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  wr_u32(buf + off, 1); off += 4;   /* r1 Bool */
  wr_u32(buf + off, 1); off += 4;   /* r2 Bool */
  wr_u32(buf + off, 1); off += 4;   /* r3 Bool */

  /* r0=10; r1=(r0==10); r2=(r0<5); r3=(r0<15); ret r3 -> true */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 10);
  wr_insn(buf, &off, (uint8_t)JOP_EQ_I32_IMM, 1, 0, 10, 0);   /* r1 = (r0==10) */
  wr_insn(buf, &off, (uint8_t)JOP_LT_I32_IMM, 2, 0, 5, 0);    /* r2 = (r0<5) = false */
  wr_insn(buf, &off, (uint8_t)JOP_LT_I32_IMM, 3, 0, 15, 0);   /* r3 = (r0<15) = true */
  wr_insn(buf, &off, (uint8_t)JOP_RET, 3, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_true(t, jelly_is_bool(v) && jelly_as_bool(v) == 1, "eq_imm and lt_imm yield true");
...
static int run_exec_lt_f64(void) {
  const char* t = "exec_lt_f64";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4;  /* ntypes: I32, F64, Bool */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;

  wr_type(buf, &off, (uint8_t)JELLY_T_I32, 0);  /* 0 */
  wr_type(buf, &off, (uint8_t)JELLY_T_F64, 0);  /* 1 */
  wr_type(buf, &off, (uint8_t)JELLY_T_BOOL, 0); /* 2 */

  /* regs: r0 i32, r1 i32, r2 f64, r3 f64, r4 bool */
  wr_u32(buf + off, 5); off += 4;
  ...
  /* r0=1; r1=2; r2=f64(r0); r3=f64(r1); r4=(r2<r3); ret r4 -> true */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 1);
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 2);
  wr_insn(buf, &off, (uint8_t)JOP_F64_FROM_I32, 2, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_F64_FROM_I32, 3, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_LT_F64, 4, 2, 3, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 4, 0, 0, 0);

  jelly_bc_module* m = NULL;
  jelly_bc_result r = jelly_bc_read(buf, off, &m);
  assert_true(t, r.err == JELLY_BC_OK, "module loads");
  if(r.err != JELLY_BC_OK) return 1;

  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_bool_eq(t, v, 1, "lt_f64 yields true");
...
static int run_exec_lt_f32(void) {
  const char* t = "exec_lt_f32";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4;  /* ntypes: I32, F32, Bool */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  wr_type(buf, &off, (uint8_t)JELLY_T_I32, 0);  /* 0 */
  wr_type(buf, &off, (uint8_t)JELLY_T_F32, 0);  /* 1 */
  wr_type(buf, &off, (uint8_t)JELLY_T_BOOL, 0); /* 2 */

  /* regs: r0 i32, r1 i32, r2 f32, r3 f32, r4 bool */
  wr_u32(buf + off, 5); off += 4;
  wr_u32(buf + off, 6); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0=1; r1=2; r2=f32(r0); r3=f32(r1); r4=(r2<r3); ret r4 -> true */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 1);
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 2);
  wr_insn(buf, &off, (uint8_t)JOP_F32_FROM_I32, 2, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_F32_FROM_I32, 3, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_LT_F32, 4, 2, 3, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 4, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_bool_eq(t, v, 1, "lt_f32 yields true");
...
static int run_exec_lt_i64(void) {
  const char* t = "exec_lt_i64";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4;  /* ntypes: I32, I64, Bool */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  wr_type(buf, &off, (uint8_t)JELLY_T_I32, 0);  /* 0 */
  wr_type(buf, &off, (uint8_t)JELLY_T_I64, 0);  /* 1 */
  wr_type(buf, &off, (uint8_t)JELLY_T_BOOL, 0); /* 2 */

  /* regs: r0 i32, r1 i32, r2 i64, r3 i64, r4 bool */
  wr_u32(buf + off, 5); off += 4;
  wr_u32(buf + off, 6); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0=1; r1=2; r2=sext_i64(r0); r3=sext_i64(r1); r4=(r2<r3); ret r4 -> true */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 1);
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 2);
  wr_insn(buf, &off, (uint8_t)JOP_SEXT_I64, 2, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_SEXT_I64, 3, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_LT_I64, 4, 2, 3, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 4, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_bool_eq(t, v, 1, "lt_i64 yields true");
...
static int run_exec_array_default_i32_zero(void) {
  const char* t = "exec_array_default_i32_zero";
  uint8_t buf[512];
  size_t off = 0;
  ...
  // regs: r0:Array, r1:i32(len), r2:i32(idx), r3:i32(out)
  wr_u32(buf + off, 4); off += 4;
  wr_u32(buf + off, 5); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  // new array len=3; get idx=1; ret -> 0
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 3);
  wr_insn(buf, &off, (uint8_t)JOP_ARRAY_NEW, 0, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 2, 0, 0, 1);
  wr_insn(buf, &off, (uint8_t)JOP_ARRAY_GET, 3, 0, 2, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 3, 0, 0, 0);
  ...
  assert_i32_eq(t, out, 0, "Array<I32> default element is 0");
...
static int run_exec_i8_i16_arith_cmp_relaxed(void) {
  const char* t = "exec_i8_i16_arith_cmp_relaxed";
  uint8_t buf[768];
  size_t off = 0;

  /* Validation test: relaxed I8/I16 on ADD_I32, SUB_I32, MUL_I32, NEG_I32, EQ_I32, LT_I32 */
  wr_u32(buf + off, JELLY_BC_MAGIC); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 4); off += 4; /* ntypes: I8, I16, I32, Bool */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:I8, r1:I8, r2:I16, r3:I16, r4:Bool, r5:I32 (out) */
  wr_u32(buf + off, 6); off += 4;
  ...
  /* r0=50, r1=30 -> ADD_I32 r0,r0,r1 (I8+I8->I8: 80, in range) */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 50);
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 30);
  wr_insn(buf, &off, (uint8_t)JOP_ADD_I32, 0, 0, 1, 0);
  /* r2=1000, r3=200 -> SUB_I32 r2,r2,r3 (I16-I16->I16: 800) */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 2, 0, 0, 1000);
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 3, 0, 0, 200);
  wr_insn(buf, &off, (uint8_t)JOP_SUB_I32, 2, 2, 3, 0);
  /* EQ_I32 r4,r0,r2: 80 == 800 -> false. LT_I32 r4,r2,r0: 800 < 80 -> false */
  wr_insn(buf, &off, (uint8_t)JOP_EQ_I32, 4, 0, 2, 0);
  wr_insn(buf, &off, (uint8_t)JOP_LT_I32, 4, 2, 0, 0);
  /* r5 = r0 + r2 (80 + 800 = 880) as I32 for return */
  wr_insn(buf, &off, (uint8_t)JOP_MOV, 5, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_ADD_I32, 5, 5, 2, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 5, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  /* r0=80 (I8), r2=800 (I16). r5 = r0+r2 = 880 */
  assert_i32_eq(t, v, 880, "i8/i16 arith and cmp relaxed");
...
static int run_exec_from_dyn_f32(void) {
  const char* t = "exec_from_dyn_f32";
  uint8_t buf[768];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4; /* ntypes: I32, F32, Dynamic */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:I32, r1:F32, r2:Dynamic, r3:F32, r4:I32(out) */
  wr_u32(buf + off, 5); off += 4;
  wr_u32(buf + off, 6); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  ...
  /* r0=7; r1=f32_from_i32(r0); r2=ToDyn(r1); r3=FromDyn_F32(r2); r4=i32_from_f32(r3); ret r4 */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 7);
  wr_insn(buf, &off, (uint8_t)JOP_F32_FROM_I32, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_TO_DYN, 2, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_FROM_DYN_F32, 3, 2, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_I32_FROM_F32, 4, 3, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 4, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 7, "from_dyn_f32 unboxes f32 (7.0 -> 7)");
...
static int run_exec_const_i8_imm(void) {
  const char* t = "exec_const_i8_imm";
  uint8_t buf[512];
  size_t off = 0;
  ...
  /* CONST_I8_IMM: a=dst, c=imm8 (signed). Store 42 via c=42. */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I8_IMM, 0, 0, 42, 0);
  wr_insn(buf, &off, (uint8_t)JOP_TO_DYN, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 1, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 42, "const_i8_imm stores 42");
...
static int run_exec_f16_i32_convert(void) {
  const char* t = "exec_f16_i32_convert";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4; /* ntypes: I32, F16, F32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  wr_type(buf, &off, (uint8_t)JELLY_T_I32, 0);
  wr_type(buf, &off, (uint8_t)JELLY_T_F16, 0);
  wr_type(buf, &off, (uint8_t)JELLY_T_F32, 0);

  /* r0:I32, r1:F16, r2:I32. CONST_I32 7; F16_FROM_I32 r1,r0; I32_FROM_F16 r2,r1; RET r2 */
  wr_u32(buf + off, 3); off += 4;
  wr_u32(buf + off, 4); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  ...
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 0, 0, 0, 7);
  wr_insn(buf, &off, (uint8_t)JOP_F16_FROM_I32, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_I32_FROM_F16, 2, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 2, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 7, "f16_from_i32 and i32_from_f16 roundtrip 7");
...
static int run_exec_f16_arith(void) {
  const char* t = "exec_f16_arith";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4; /* ntypes: F16, F32, I32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:F16, r1:F16, r2:F16, r3:I32. CONST_F16 1.0 (0x3C00) and 0.5 (0x3800); ADD_F16; I32_FROM_F16; RET */
  wr_u32(buf + off, 4); off += 4;
  wr_u32(buf + off, 5); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 2); off += 4;  /* r3:I32 = type 2 */

  wr_insn(buf, &off, (uint8_t)JOP_CONST_F16, 0, 0, 0, 0x3C00); /* 1.0 */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_F16, 1, 0, 0, 0x3800); /* 0.5 */
  wr_insn(buf, &off, (uint8_t)JOP_ADD_F16, 2, 0, 1, 0);      /* 1.0 + 0.5 = 1.5 */
  wr_insn(buf, &off, (uint8_t)JOP_I32_FROM_F16, 3, 2, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 3, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 1, "add_f16 1.0+0.5=1.5 -> i32 1");
...
static int run_exec_const_f16_to_dyn(void) {
  const char* t = "exec_const_f16_to_dyn";
  uint8_t buf[512];
  size_t off = 0;
  ...
  /* CONST_F16: 1.0 in IEEE 754 binary16 = 0x3C00 */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_F16, 0, 0, 0, 0x3C00);
  wr_insn(buf, &off, (uint8_t)JOP_TO_DYN, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 1, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  /* F16 1.0 boxed -> unbox as f64 for return? No - ret boxes the value. We get a box_f16. */
  assert_true(t, jelly_is_ptr(v), "result is ptr (box_f16)");
  assert_true(t, jelly_obj_kind_of(v) == (uint32_t)JELLY_OBJ_BOX_F16, "result is box_f16");
  assert_true(t, jelly_as_box_f16(v) == 0x3C00, "f16 value is 1.0");
...
static int run_exec_from_dyn_i8(void) {
  const char* t = "exec_from_dyn_i8";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4; /* ntypes: I8, Dynamic, I32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:I8, r1:Dynamic, r2:I32 (return) */
  wr_u32(buf + off, 3); off += 4;
  wr_u32(buf + off, 5); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  ...
  /* CONST_I32 100 -> r2; TO_DYN r1,r2; FROM_DYN_I8 r0,r1; RET r0 via I32... need Dynamic ret. Use r1=ToDyn(r0), RET r1 */
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 2, 0, 0, 100);
  wr_insn(buf, &off, (uint8_t)JOP_TO_DYN, 1, 2, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_FROM_DYN_I8, 0, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_MOV, 2, 0, 0, 0); /* r2 = r0 (I8->I32 copy for return; MOV works on slots) */
  wr_insn(buf, &off, (uint8_t)JOP_RET, 2, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 100, "from_dyn_i8 unboxes 100");
...
static int run_exec_from_dyn_i16(void) {
  const char* t = "exec_from_dyn_i16";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4; /* ntypes: I16, Dynamic, I32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 2, 0, 0, 1234);
  wr_insn(buf, &off, (uint8_t)JOP_TO_DYN, 1, 2, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_FROM_DYN_I16, 0, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_MOV, 2, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 2, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 1234, "from_dyn_i16 unboxes 1234");
...
static int run_exec_sext_i16(void) {
  const char* t = "exec_sext_i16";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 3); off += 4; /* ntypes: I8, I16, I32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:I8, r1:I16, r2:I32 (return). CONST_I8_IMM -5; SEXT_I16 r1,r0; MOV r2,r1; RET r2 */
  wr_u32(buf + off, 3); off += 4;
  wr_u32(buf + off, 4); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  ...
  wr_insn(buf, &off, (uint8_t)JOP_CONST_I8_IMM, 0, 0, (uint8_t)(int8_t)-5, 0);
  wr_insn(buf, &off, (uint8_t)JOP_SEXT_I16, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_MOV, 2, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 2, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, -5, "sext_i16 extends -5 from i8 to i16");
...
static int run_exec_trunc_i8(void) {
  const char* t = "exec_trunc_i8";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 2); off += 4; /* ntypes: I8, I32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:I8, r1:I32. CONST_I32 300; TRUNC_I8 r0,r1; MOV r1,r0; RET r1. 300 truncates to (int8_t)300 = 44 */
  wr_u32(buf + off, 2); off += 4;
  wr_u32(buf + off, 4); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;

  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 300);
  wr_insn(buf, &off, (uint8_t)JOP_TRUNC_I8, 0, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_MOV, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 1, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 44, "trunc_i8 300 -> 44");
...
static int run_exec_trunc_i16(void) {
  const char* t = "exec_trunc_i16";
  uint8_t buf[512];
  size_t off = 0;
  ...
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 2); off += 4; /* ntypes: I16, I32 */
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;
  wr_u32(buf + off, 0); off += 4;
  ...
  /* r0:I16, r1:I32. CONST_I32 70000; TRUNC_I16 r0,r1; MOV r1,r0; RET r1. 70000 truncates to (int16_t)70000 = 4464 */
  wr_u32(buf + off, 2); off += 4;
  wr_u32(buf + off, 4); off += 4;
  wr_u32(buf + off, 0); off += 4;
  wr_u32(buf + off, 1); off += 4;

  wr_insn(buf, &off, (uint8_t)JOP_CONST_I32, 1, 0, 0, 70000);
  wr_insn(buf, &off, (uint8_t)JOP_TRUNC_I16, 0, 1, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_MOV, 1, 0, 0, 0);
  wr_insn(buf, &off, (uint8_t)JOP_RET, 1, 0, 0, 0);
  ...
  jelly_vm* vm = jelly_vm_create();
  jelly_value v = jelly_vm_exec(vm, m);
  assert_i32_eq(t, v, 4464, "trunc_i16 70000 -> 4464");
...
int main(int argc, char** argv) {
  ...
  if(strcmp(name, "exec_i32_imm_arith") == 0) return run_exec_i32_imm_arith();
  if(strcmp(name, "exec_i32_imm_cmp") == 0) return run_exec_i32_imm_cmp();
  if(strcmp(name, "exec_lt_f64") == 0) return run_exec_lt_f64();
  if(strcmp(name, "exec_lt_f32") == 0) return run_exec_lt_f32();
  if(strcmp(name, "exec_lt_i64") == 0) return run_exec_lt_i64();
  ...
  if(strcmp(name, "exec_array_default_i32_zero") == 0) return run_exec_array_default_i32_zero();
  ...
  if(strcmp(name, "exec_i8_i16_arith_cmp_relaxed") == 0) return run_exec_i8_i16_arith_cmp_relaxed();
  ...
  if(strcmp(name, "exec_const_i8_imm") == 0) return run_exec_const_i8_imm();
  if(strcmp(name, "exec_const_f16_to_dyn") == 0) return run_exec_const_f16_to_dyn();
  if(strcmp(name, "exec_f16_i32_convert") == 0) return run_exec_f16_i32_convert();
  if(strcmp(name, "exec_f16_arith") == 0) return run_exec_f16_arith();
  if(strcmp(name, "exec_from_dyn_i8") == 0) return run_exec_from_dyn_i8();
  if(strcmp(name, "exec_from_dyn_i16") == 0) return run_exec_from_dyn_i16();
  if(strcmp(name, "exec_from_dyn_f32") == 0) return run_exec_from_dyn_f32();
  if(strcmp(name, "exec_sext_i16") == 0) return run_exec_sext_i16();
  if(strcmp(name, "exec_trunc_i8") == 0) return run_exec_trunc_i8();
  if(strcmp(name, "exec_trunc_i16") == 0) return run_exec_trunc_i16();
